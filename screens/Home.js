...
const Home = () => {
        ...
        return (
            <View style={{
                ...
                <View style={{
                    ...
                    <View style={{
                        height: 50,
                        width: 50, backgroundColor: COLORS.lightGray,
                        borderRadius: 25,
    ...
    function renderCategoyHeaderSection() {
        return (
            <View style={{
                flexDirection: 'row',
                padding: SIZES.padding, justifyContent: 'space-between', alignItems: 'center'
            }}>
                <View>
                        ...
                        eventHandlers: {
                            onPress: () => {
                                return [{
                                    target: "labels",
                                    mutation: (props) => {
                                        let categoyName = chartData[props.index].name
                                        setSelectCategoryByName(categoyName)
                                    }
                                }]
                            }
                        }
            ...
            return (
                ...
                >
                    <View
                        ...
                        <Text style={{
                            marginLeft: SIZES.base, ...FONTS.h3,
